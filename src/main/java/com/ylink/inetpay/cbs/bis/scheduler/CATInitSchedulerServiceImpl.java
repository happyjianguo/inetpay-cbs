 ...
 *
 */
public class CATInitSchedulerServiceImpl implements
		SchedulerService {

	private static final long serialVersionUID = 1L;
	
	private static Logger _log = LoggerFactory.getLogger(CATInitSchedulerServiceImpl.class);
	...
	public void execute() {
		try {
			...
			bisExceptionLogDto.setContent("巨灾清结算任务初始化失败："+e.getMessage());
