 ...
 *
 */
public class CATCreateSchedulerServiceImpl implements
		SchedulerService {

	private static final long serialVersionUID = 1L;
	
	private static Logger _log = LoggerFactory.getLogger(CATCreateSchedulerServiceImpl.class);
