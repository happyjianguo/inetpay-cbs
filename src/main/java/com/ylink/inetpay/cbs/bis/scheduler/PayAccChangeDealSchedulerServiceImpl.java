 ...
 *
 */
public class PayAccChangeDealSchedulerServiceImpl implements
		SchedulerService {

	private static final long serialVersionUID = 1L;
	
	private static Logger _log = LoggerFactory.getLogger(PayAccChangeDealSchedulerServiceImpl.class);
	...
	public void execute() {
		try {
			payAccChangeNotifyAppService.dealAccChangeNoticify();
		} catch (Exception e) {
			...
			bisExceptionLogDto.setContent("动账通知处理失败");
