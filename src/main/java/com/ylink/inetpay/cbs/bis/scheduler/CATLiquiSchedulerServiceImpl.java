 ...
 *
 */
public class CATLiquiSchedulerServiceImpl implements
		SchedulerService {

	private static final long serialVersionUID = 1L;
	
	private static Logger _log = LoggerFactory.getLogger(CATLiquiSchedulerServiceImpl.class);
	...
	public void execute() {
		try {
			clearCATAppService.liquidation();
		} catch (Exception e) {
